...
Log = False
# Saves data automatically and continues counting from previous session
AutoSave = False
# Saves data to separate files each day at a specified time and resets the counter
DaySave = False
# Time when day data will be saved (e.g. TimeDaySave = '00:00:00')
TimeDaySave = "00:00:00"
